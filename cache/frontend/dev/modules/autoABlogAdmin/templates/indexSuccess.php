...
<div class="a-ui a-admin-header">
	<h3 class="a-admin-title"><?php echo __('Blog Admin', array(), 'apostrophe') ?></h3>
	<ul class="a-ui a-controls a-admin-controls">
    <?php include_partial('aBlogAdmin/list_actions', array('helper' => $helper)) ?>   
  </ul>
  <?php include_partial('aBlogAdmin/list_bar', array('filters' => $filters, 'configuration' => $configuration)) ?>
</div>
<?php end_slot() ?>
...
<div class="a-ui a-admin-container <?php echo $sf_params->get('module') ?>">
	...
	<div class="a-admin-content main">
		...
		<?php include_partial('aBlogAdmin/flashes') ?>
					...
					<form action="<?php echo url_for('a_blog_admin_collection', array('action' => 'batch')) ?>" method="post" id="a-admin-batch-form">
